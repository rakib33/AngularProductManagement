...
var NgxMyDatePickerModule = /** @class */ (function () {
    function NgxMyDatePickerModule() {
    }
    NgxMyDatePickerModule_1 = NgxMyDatePickerModule;
    NgxMyDatePickerModule.forRoot = function () {
        return {
            ngModule: NgxMyDatePickerModule_1,
            providers: [NgxMyDatePickerConfig]
        };
    };
    var NgxMyDatePickerModule_1;
    NgxMyDatePickerModule = NgxMyDatePickerModule_1 = __decorate([
        NgModule({
